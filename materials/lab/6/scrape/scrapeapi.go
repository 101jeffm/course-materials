...
func MainPage(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, "<html><body><H1>To work API: Affix URL with /indexer, /search, /addsearch/{regex}, /clear, or /reset</H1></body>")
}
...
func Reset(w http.ResponseWriter, r *http.Request) {
	...
	resetRegEx()
	Files = nil
	json.NewEncoder(w).Encode("Reset Performed")	
}
...
func Clear(w http.ResponseWriter, r *http.Request) {
    ...
    w.Header().Set("Content-Type", "application/json")
	clearRegEx()
	json.NewEncoder(w).Encode("Clear performed")	
}	
...
func AddSearch(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode("AddSearch performed")
}	